...
function PaletteControls() {
  ...
  return (
    <fieldset className="has-focus-visible:bg-accent/20 flex h-[176px] w-full flex-col flex-wrap justify-center gap-2 overflow-x-auto p-2 lg:h-auto lg:flex-row lg:gap-4">
